<x-app-layout>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s"
        style=" background: linear-gradient(rgba(3, 27, 78, .4), rgba(3, 27, 78, .4)), url({{ asset('assets/images/gallery/1.jpg') }}) center center no-repeat; background-position: center; background-size: cover ">
