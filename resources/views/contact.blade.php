<x-app-layout>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s" style=" background: linear-gradient(rgba(3, 27, 78, .4), rgba(3, 27, 78, .4)), url({{asset('assets/images/banner/1.png')}}) center center no-repeat; background-position: center; background-size: cover ">
                ...
                <div class="col-lg-6">
                    <a href="tel:+0123456789" class="d-flex justify-content-lg-center bg-primary p-4">
                        ...
                        <div class="ms-3">
                            ...
                            <h2 class="text-white mb-0">+91-172-0000000</h2>
                        </div>
                    </a>
                </div>
                <div class="col-lg-6">
                    <a href="mailto:info@example.com" class="d-flex justify-content-lg-center bg-primary p-4">
                        ...
                        <div class="ms-3">
                            ...
                            <h2 class="text-white mb-0">lab@lolitikamlab.in</h2>
                        </div>
                    </a>
                </div>
            </div>
