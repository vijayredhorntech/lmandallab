<x-app-layout>
    @php
        ...
        $developmentGeneticsLab = [
            [
                'name' => 'Prof. Sudip Mandal',
                'role' => 'Group Leader',
                'image' => asset('assets/images/labMembers/Molecular Cell and Development Biology Lab/Prof Sudip.png'),
                'bio' =>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s"
        style=" background: linear-gradient(rgba(3, 27, 78, .4), rgba(3, 27, 78, .4)), url({{ asset('assets/images/banner/1banner.png') }}) center center no-repeat; background-position: center; background-size: cover ">
        <div class="container text-center py-5 mt-4">
            <h1 class="display-2 text-white mb-3 animated slideInDown">Molecular Cell and Development Biological Lab</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('index') }}">Home</a></li>
                    <li class="breadcrumb-item" aria-current="page">Molecular Cell and Development Biological Lab</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="col wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item position-relative overflow-hidden group h-100">
                            <div class="member-image-container position-relative"
                                ...
                                <img class="img-fluid w-100 h-100 transition-all duration-300 group-hover:scale-110"
                                ...
                                <div
                                    ...
                                    <a class="btn btn-square btn-light mx-1 flex items-center justify-center"
