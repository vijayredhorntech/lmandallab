    ...
    <div class="container">
        <div class="row g-5 py-5">
            <div class="col-lg-6 pe-lg-5">
                ...
                <h1 class="h3 text-primary mb-0">Visitors Count: <span class="text-white"
                        id="visitor-count">Loading...</span></h1>
            </div>
            <div class="col-lg-6 ps-lg-5">
                <div class="row g-5">
                    ...
                    <div class="col-sm-6">
                        <h4 class="text-light mb-4">Online Resources</h4>
                        @php
                            $OnlineResources = [
                                ['name' => 'FlyBase', 'link' => 'https://flybase.org/'],
                                [
                                ...
                                ['name' => 'SDB Online', 'link' => 'https://www.sdbonline.org/'],
                                ['name' => 'Droso 4 Schools', 'link' => 'https://droso4schools.wordpress.com/'],
                                [
                        ...
                        <ul>
                            @foreach ($OnlineResources as $resource)
                                <li>
                                    <a class="btn btn-link text-light" href="{{ $resource['link'] }}" target="_blank">
                                        {{ $resource['name'] }}
                                    </a>
                                </li>
                            @endforeach
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center text-md-start">
                <p class="mb-0">&copy; <a href="{{ route('index') }}">Lolitika_Mandal_Lab</a>. All Rights Reserved.
                </p>
            </div>
            <div class="col-md-6 text-center text-md-end">
                <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                <p class="mb-0">Designed by <a href="https://himsoftsolution.com" target="_blank">Him Soft
                        Solution</a></p>
            </div>
        </div>
    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('visitor-count').textContent = displayCount
    .toLocaleString(); // Add commas for readability
    });
</script>
